...
| Analytics               | Proveedor, owner, IDs públicos si existen y requisitos de consentimiento/privacidad | `READY`   | Titular de Luna Tartas   | M9.4 / validación post-despliegue                         | Consolidado 2026-08-20: GA4 directo sin GTM, propiedad/stream productivos, Measurement ID `G-DV6KHV0YMW`, opt-in, Signals/User-ID/datos de usuario/formularios y publicidad desactivados. La validación real de Network/Realtime/DebugView sigue en M9.4; contrato en `docs/conversion/analytics-decision.md` |
