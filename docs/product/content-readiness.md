...
| DNS/Cloudflare          | Acceso operativo, export de zona, reglas, TTL y rollback owner                      | `READY` | Propietario del negocio  | M9.2/M9.3                                                | Cerrado 2026-08-20: owner aplicó Bulk Redirects/Worker, el checker productivo validó 301/410 y M9.3 verificó apex, `www`, HTTPS, Pages y rollback                                                                                               |
