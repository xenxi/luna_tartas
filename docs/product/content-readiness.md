...
| Marca                   | Variantes restantes, favicon e iconos en formatos web                               | `BLOCKED` | Propietario del negocio  | bloquea identidad visual definitiva; no M3.2 provisional | Entregar masters, autor/licencia, reglas de uso y aprobación                                                                                                                                                                            |
...
| Analytics               | Proveedor, owner, IDs públicos si existen y requisitos de consentimiento/privacidad | `READY`   | Titular de Luna Tartas   | M7.2 / alta de producción                                | M7.1 (2026-08-17) selecciona Matomo On-Premise EEE, consentimiento opt-in y estado inicial desactivado. Endpoint/site ID se entregan sólo al alta aprobada; contrato y revisión en `docs/conversion/analytics-decision.md` |
